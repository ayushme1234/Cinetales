...
export async function getPopularMovies(page = 1) {
  return tmdb(`/movie/popular`, { language: "en-US", page }, 3600);
}
...
export async function getNowPlayingMovies(page = 1) {
  return tmdb(`/movie/now_playing`, { language: "en-US", page, region: "IN" }, 1800);
}

export async function getUpcomingMovies(page = 1) {
  return tmdb(`/movie/upcoming`, { language: "en-US", page, region: "IN" }, 1800);
}
...
export async function discoverMovies({ genre, year, sortBy = "popularity.desc", minRating, page = 1 } = {}) {
...
export async function discoverTV({ genre, year, sortBy = "popularity.desc", minRating, page = 1 } = {}) {
...
/** Extract watch providers, prioritizing IN region with sensible fallbacks. */
